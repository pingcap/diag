...
func (t *saveBasicInfoTask) Run(c *boot.Config, e *envs.Env, m *boot.Model, meta *meta.Meta, topo *model.Topology, countDone *meta.CountComponentsDone) {
	...
	info := &model.BasicInfo{
		...
		ClusterName:       topo.ClusterName,
		ClusterCreateTime: clusterCreateTime,
		InspectTime:       meta.InspectTime,
